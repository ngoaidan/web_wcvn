...
<form action="#" accept-charset="UTF-8" method="post" id="form-payment" class="form-style-base">      <div class="form-group">
...
<form action="/#" accept-charset="UTF-8" method="post"><fieldset>          <div>
...
<form action="/#" accept-charset="UTF-8" method="post" class="form-style-base"><fieldset>              <div class="form-group">
...
</fieldset><fieldset>              <input type="submit" value="SUBSCRIBE YOU" class="btn btn-warning btn-lg no-margin" />
</fieldset></form>        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="inner-container bg-white">
        <div class="modal-body clearfix">
<form action="#" accept-charset="UTF-8" method="post" class="form-style-base"><fieldset>              <div class="input-group">
...
</fieldset>            <button type="submit" class="btn btn-success btn-lg btn-block">
              Login
            </button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="inner-container clearfix">
        ...
        <div class="modal-body clearfix">
          <div class="col-md-7 no-padding">
<form action="/#" accept-charset="UTF-8" method="post" class="form-style-base">              <div class="form-group">
...
<form action="#" accept-charset="UTF-8" method="post" class="form-style-base"><input type="hidden" name="_method" value="put" /><fieldset>              <div class="row clearfix">
    ...
    <div class="modal-content">
      <div class="inner-container">
        ...
        <div class="modal-body">
          ...
          <form action="#" accept-charset="UTF-8" class="form-style-base" method="post" id="buy-voucher"><fieldset class="spacer-bottom-20">
    <div class="row clearfix">
      <div class="col-sm-6 form-group">
        <select name="select-amount" class="input-lg" id="select-amount"><option value="Select amount" selected="selected">Select amount</option>
...
<fieldset>    <div class="clearfix row">
...
</a>              <ul class="dropdown-menu list-unstyled">
                <li>
